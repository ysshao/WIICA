...
def run(directory,
  ...
  compile.main(directory, kernel, test_file, source, arguments)
...
def main():
  ...
  parser.add_argument('--test_file', help='test file. If no test file, input non')
  ...
  if len(sys.argv) < 2:
    print "run_wiica.py --directory <dir> --kernel <kernel> --source <source file> --arguments <args> --test_file <test file> --analysis_types <analysis to do> "
